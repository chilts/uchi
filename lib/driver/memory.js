...
// set up the uchi meta namespace
var meta = Object.create(null);
meta.lastUsedTime = Object.create(null);
...
// getKeys(cb) : returns all the keys in this namespace
...
// getNamespaces(cb) : returns all the namespaces
...
Memory.prototype.clear = function(callback) {
...
Memory.prototype.discardPolicyLRU = function() {
    ...
    return Object.keys( meta.lastUsedTime ).sort();
